...
- `r lm0.percent` % of variance games played per season explained by player's age
- `r lm1.percent` % of variance games played per season explained by previous year's games played
- `r lm2.percent` % of variance games played per season explained by previous year's games played AND player age
